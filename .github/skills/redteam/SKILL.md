---
name: redteam
description: RedTeam penetration testing agent skill. Use this for network scanning, web fingerprinting, vulnerability detection, AD domain attacks, lateral movement, credential harvesting with tools like gogo, fscan, httpx, nuclei, ffuf, dnsx, kerbrute, nxc, impacket.
---
